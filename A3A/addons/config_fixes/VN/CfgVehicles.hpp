class CfgVehicles {
	...
	class a3a_vn_b_wheeled_m54_mg_02_base: vn_b_wheeled_m54_mg_02 {
		scope = 0; 
		class Turrets : Turrets { 
			class MainTurret; 
		}; 
	};
	class a3a_vn_b_wheeled_m54_mg_02: a3a_vn_b_wheeled_m54_mg_02_base {
		scope = 2;
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				magazines[] = {"a3a_quadmount_800_mag","a3a_quadmount_800_mag"};
				weapons[] = {"a3a_vn_m2_v_quad"};
			};
		};
	};
	...
	class a3a_vn_b_army_static_m45_base: vn_b_army_static_m45 {
		scope = 0; 
		class Turrets : Turrets { 
			class MainTurret; 
		}; 
	};
	class a3a_vn_b_army_static_m45: a3a_vn_b_army_static_m45_base {
		scope = 2;
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				magazines[] = {"a3a_quadmount_800_mag","a3a_quadmount_800_mag"};
	...
	class a3a_vn_o_nva_static_zgu1_01_base: vn_o_nva_static_zgu1_01 {
		scope = 0; 
		class Turrets : Turrets { 
			class MainTurret; 
		}; 
	};
	class a3a_vn_o_nva_static_zgu1_01: a3a_vn_o_nva_static_zgu1_01_base {
		scope = 2;
		class Turrets : Turrets {
			class MainTurret : MainTurret {
				magazines[] = {"vn_zgu1_v_70_mag","vn_zgu1_v_70_mag","vn_zgu1_v_70_mag","vn_zgu1_v_70_mag"};
			};
		};
	};
};