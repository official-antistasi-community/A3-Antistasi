...
if (A3A_GUIDevPreview) then {
    flagX addAction [localize "STR_A3A_fn_init_initclient_addact_recruit", { createDialog "A3A_RecruitDialog"; },nil,0,false,true,"","A3A_GUIDevPreview and (petros == leader group petros)",4];
