...
switch _typeX do
{
    ...
    case "petros":
    {
        ...
        if (A3A_GUIDevPreview) then {
            petros addAction [localize "STR_A3A_fn_base_flagaction_hq_manage", { createDialog "A3A_HqDialog"; },nil,0,false,true,"","A3A_GUIDevPreview and (_this == theBoss) and (petros == leader group petros)",4];
            petros addAction [localize "STR_A3A_fn_base_flagaction_missionrequest", { createDialog "A3A_RequestMissionDialog"; },nil,0,false,true,"","A3A_GUIDevPreview and ([_this] call A3A_fnc_isMember or _this == theBoss)",4];
        } else {
