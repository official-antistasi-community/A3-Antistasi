...
switch _typeX do
{
    ...
    ERROR("Disabled due to UseDoomGUI Switch.")
        ...
        petros addAction ["Mission Request WIP", { createDialog "A3A_RequestMissionDialog"; },nil,0,false,true,"","A3A_GUIDevPreview and ([_this] call A3A_fnc_isMember or _this == theBoss)",4];
    };
    case "truckX":
    {
