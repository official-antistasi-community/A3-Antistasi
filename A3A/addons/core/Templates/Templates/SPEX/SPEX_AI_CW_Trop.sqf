...
["vehiclesLightUnarmed", ["SPEX_CW_Trop_G503_MB", "SPEX_CW_Trop_G503_MB", "SPEX_CW_trop_Bedford_MWD_Open"]] call _fnc_saveToTemplate;
...
["vehiclesIFVs", ["SPEX_CW_Trop_M10"]] call _fnc_saveToTemplate;
private _vehiclesLightTanks = ["SPEX_CW_Trop_M10", "SPEX_CW_Trop_Humber_MkII"];
...
if (isClass (configFile >> "CfgPatches" >> "MWB_M24Chaffee")) then {
    _vehiclesLightTanks append ["a3a_MWB_M24Chaffee_UK"];
};
if (isClass (configFile >> "CfgPatches" >> "SPEV_SPEX")) then {
    _vehiclesLightTanks append ["SPEV_CW_Trop_T17E1"];
};
...
["vehiclesMilitiaLightArmed", ["SPEX_CW_Trop_Humber_LRC"]] call _fnc_saveToTemplate;
...
_sfLoadoutData set ["uniforms", ["U_SPEX_CW_BD_KD_puttee_roll", "U_SPEX_CW_BD_KD_puttee", "U_SPEX_CW_BD_KD_roll","U_SPEX_CW_BD_KD"]];
_sfLoadoutData set ["medUniforms", []];
_sfLoadoutData set ["engUniforms", []];
_sfLoadoutData set ["slUniforms", ["U_SPEX_CW_BD_KD_long_1LT", "U_SPEX_CW_BD_KD_long_puttee_1LT"]];

_sfLoadoutData set ["helmets", ["H_SPEX_CW_beret_RECCE","H_SPEX_CW_beret_RECCE_goggle"]];
_sfLoadoutData set ["medHelmets", []];
_sfLoadoutData set ["slHelmets", ["H_SPEX_CW_beret_RECCE","H_SPEX_CW_beret_RECCE_goggle"]];
_sfLoadoutData set ["sniHelmets", ["H_SPEX_CW_beret_RECCE"]];
...
_militaryLoadoutData set ["uniforms", ["U_SPEX_CW_Bush_short_puttee_roll","U_SPEX_CW_Bush_short_puttee","U_SPEX_CW_KD_full_puttee_roll", "U_SPEX_CW_KD_full_puttee", "U_SPEX_CW_KD_full_roll", "U_SPEX_CW_KD_full"]];
_militaryLoadoutData set ["medUniforms", ["U_SPEX_CW_KD_full_medic_sb","U_SPEX_CW_KD_full_medic", "U_SPEX_CW_KD_full_medic"]];
_militaryLoadoutData set ["engUniforms", []];
_militaryLoadoutData set ["slUniforms", ["U_SPEX_CW_Bush_short_puttee_1LT"]];

_militaryLoadoutData set ["helmets", ["H_SPEX_CW_Helmet_mk2_burlap","H_SPEX_CW_Helmet_mk2_desert","H_SPEX_CW_Helmet_mk2_desert_net","H_SPEX_CW_Helmet_mk2_burlap_op","H_SPEX_CW_Helmet_mk2_burlap_tilt", "H_SPEX_CW_Helmet_mk2_desert_op_tilt", "H_SPEX_CW_Helmet_mk2_desert_net_op_tilt", "H_SPEX_CW_Helmet_mk2"]];
_militaryLoadoutData set ["sniHelmets", ["H_SPEX_CW_Helmet_mk2_desert_op_tilt", "H_SPEX_CW_Helmet_mk2_ifak_op_tilt"]];

_militaryLoadoutData set ["lmgMag", ["SPE_30Rnd_770x56"]];
_militaryLoadoutData set ["rifles", [
["SPEX_No1_Mk3_Enfield", "SPEX_ACC_P1907_Bayo", "", "", ["SPEX_10Rnd_770x56"], [], ""],
["SPEX_No1_Mk3_mid_Enfield", "SPEX_ACC_P1907_Bayo", "", "", ["SPEX_10Rnd_770x56"], [], ""],
...
_militiaLoadoutData set ["uniforms", ["U_SPEX_AUS_KD_short_puttee_roll","U_SPEX_AUS_KD_short_puttee","U_SPEX_AUS_KD_short_roll","U_SPEX_AUS_KD_short","U_SPEX_AUS_KD_short_anklet_roll","U_SPEX_AUS_KD_short_anklet"]];
_militiaLoadoutData set ["medUniforms", ["U_SPEX_AUS_KD_short_medic"]];
