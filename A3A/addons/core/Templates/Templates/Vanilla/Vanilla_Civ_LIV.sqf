...
private _vehiclesCivCar = [
    "C_Quadbike_01_F", 0.3
    ,"C_Hatchback_01_F", 3.0
    ,"C_Hatchback_01_sport_F", 0.3
    ,"C_Offroad_01_F", 0.5
    ,"C_Van_01_box_F", 1.8
    ,"C_SUV_01_F", 1.0
    ,"C_Van_02_vehicle_F", 2.0                // van from Orange
    ,"C_Van_02_transport_F", 0.2            // minibus
    ,"C_Offroad_02_unarmed_F", 0.05            // Apex 4WD
    ,"C_Offroad_01_comms_F", 0.01            // Contact
...
private _vehiclesCivFuel = [
    "C_Van_01_fuel_F", 0.02
    ,"C_Truck_02_fuel_F", 0.1];

if ("rf" in A3A_enabledDLC) then {
    _vehiclesCivCar append ["C_Pickup_rf", 2.0, "C_Pickup_covered_rf", 0.5];
