...
["vehiclesTanks", ["B_MBT_01_cannon_F"]] call _fnc_saveToTemplate;
["vehiclesHeavyTanks", ["B_MBT_01_TUSK_F"]] call _fnc_saveToTemplate;
...
if ("ef" in A3A_enabledDLC) then {
    ...
    _vehiclesPlanesAA append ["EF_QAV80_MJTF_Des"];
