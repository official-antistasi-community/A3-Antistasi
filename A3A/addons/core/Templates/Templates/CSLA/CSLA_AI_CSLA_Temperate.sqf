...
["vehiclesLightUnarmed", ["CSLA_AZU_para", "CSLA_AZU_R2", "CSLA_AZU", "CSLA_V3SLizard"]] call _fnc_saveToTemplate;
["vehiclesLightArmed", ["CUP_O_UAZ_MG_SLA", "CUP_O_UAZ_AGS30_SLA"]] call _fnc_saveToTemplate;
["vehiclesTrucks", ["CSLA_F813o", "CSLA_F813", "CSLA_V3So", "CSLA_V3S"]] call _fnc_saveToTemplate;
["vehiclesCargoTrucks", ["CSLA_F813o"]] call _fnc_saveToTemplate;
["vehiclesAmmoTrucks", ["CSLA_V3Sa"]] call _fnc_saveToTemplate;
["vehiclesRepairTrucks", ["CSLA_V3Sr"]] call _fnc_saveToTemplate;
["vehiclesFuelTrucks", ["CSLA_V3Sf"]] call _fnc_saveToTemplate;
["vehiclesMedical", ["CSLA_OZV90"]] call _fnc_saveToTemplate;
["vehiclesLightAPCs", ["CSLA_OT64C", "CSLA_OT65A", "CSLA_OT62", "CSLA_OT62D"]] call _fnc_saveToTemplate;
["vehiclesAPCs", ["CSLA_BPzV", "CSLA_BVP1"]] call _fnc_saveToTemplate;            
["vehiclesIFVs", []] call _fnc_saveToTemplate;
["vehiclesTanks", ["CUP_O_T55_SLA", "CUP_O_T72_SLA"]] call _fnc_saveToTemplate;
["vehiclesAA", ["CSLA_PLdvK59V3S", "CUP_O_ZSU23_Afghan_SLA"]] call _fnc_saveToTemplate;
...
["vehiclesPlanesAA", ["CUP_B_L39_CZ_GREY"]] call _fnc_saveToTemplate;
...
["vehiclesArtillery", ["CSLA_ShKH77"]] call _fnc_saveToTemplate;
["magazines", createHashMapFromArray [["CSLA_ShKH77", ["CSLA_54Rnd_152EOF"]]]] call _fnc_saveToTemplate;

["uavsAttack", []] call _fnc_saveToTemplate;
["uavsPortable", []] call _fnc_saveToTemplate;

["vehiclesMilitiaLightArmed", ["CUP_O_UAZ_MG_SLA"]] call _fnc_saveToTemplate;
["vehiclesMilitiaTrucks", ["CSLA_V3So"]] call _fnc_saveToTemplate;
["vehiclesMilitiaCars", ["CSLA_AZU_para"]] call _fnc_saveToTemplate;
...
_loadoutData set ["slHat", ["CSLA_capGn"]];
_loadoutData set ["sniHats", ["CSLA_RadiovkaBk"]];
...
_sfLoadoutData set ["helmets", ["FIA_cap", "CSLA_helmet53j"]];
_sfLoadoutData set ["slHat", ["CSLA_beretM"]];
_sfLoadoutData set ["sniHats", ["CSLA_hat85Clds"]];
...
_militaryLoadoutData set ["uniforms", ["FIA_uniwld12"]];
...
_militaryLoadoutData set ["helmets", ["CSLA_helmet53", "CSLA_helmet53d", "CSLA_helmet53G_on"]];
...
_militiaLoadoutData set ["helmets", ["CSLA_helmetPara"]];
